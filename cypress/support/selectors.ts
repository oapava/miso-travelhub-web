...
export const SEL = {
  ...
  // Month/year selectors (replaced legacy start/end date pickers)
  FINANCIAL_REPORTS_MONTH_SELECT:      'financial-reports-month-select',
  FINANCIAL_REPORTS_YEAR_SELECT:       'financial-reports-year-select',
  FINANCIAL_REPORTS_DOWNLOAD_BTN:      'financial-reports-download-btn',
  // Totals panel
  FINANCIAL_REPORTS_TOTALS:            'financial-reports-totals',
  FINANCIAL_REPORTS_GROSS_VALUE:       'financial-reports-gross-value',
  FINANCIAL_REPORTS_TAXES_VALUE:       'financial-reports-taxes-value',
  FINANCIAL_REPORTS_NET_VALUE:         'financial-reports-net-value',
  // Monthly transactions
  FINANCIAL_REPORTS_REPORT_TITLE:      'financial-reports-report-title',
  FINANCIAL_REPORTS_REPORT_TABLE:      'financial-reports-report-table',
  FINANCIAL_REPORTS_REPORT_PAGINATION: 'financial-reports-report-pagination',
  // Room aggregation (secondary section)
  FINANCIAL_REPORTS_TABLE:             'financial-reports-table',
  FINANCIAL_REPORTS_PAGINATION:        'financial-reports-pagination',
  // Misc
  FINANCIAL_REPORTS_INCOME_CHART:      'financial-reports-income-chart',
  FINANCIAL_REPORTS_ERROR:             'financial-reports-error',
  ...
  PRICES_MANAGER_TABLE:      'prices-manager-table',   // DataTable (rendered when rooms exist)
  PRICES_MANAGER_LOADING:    'prices-manager-loading',
  PRICES_MANAGER_ERROR:      'prices-manager-error',
  PRICES_MANAGER_EMPTY:      'prices-manager-empty',
  PRICES_MANAGER_SAVE_ERROR: 'prices-manager-save-error',

  // ── Tariff Detail Modal (TarifaDetailModal) ──────────────────────────────────
  TARIFF_MODAL:                    'prices-manager-tariff-modal',
  TARIFF_MODAL_CONTAINER:          'prices-manager-tariff-modal-container',
  TARIFF_MODAL_TITLE:              'prices-manager-tariff-modal-title',
  TARIFF_MODAL_LOADING:            'prices-manager-tariff-modal-loading',
  TARIFF_MODAL_ERROR:              'prices-manager-tariff-modal-error',
  TARIFF_MODAL_BASE_SECTION:       'prices-manager-tariff-modal-base-section',
  TARIFF_MODAL_BASE_PRICE:         'prices-manager-tariff-modal-base-price',
  TARIFF_MODAL_BASE_DISCOUNT:      'prices-manager-tariff-modal-base-discount',
  TARIFF_MODAL_FINAL_PRICE:        'prices-manager-tariff-modal-final-price',
  TARIFF_MODAL_NO_VARIATIONS:      'prices-manager-tariff-modal-no-variations',
  TARIFF_MODAL_VARIATIONS_TABLE:   'prices-manager-tariff-modal-variations-table',
  TARIFF_MODAL_CLOSE_BTN:          'prices-manager-tariff-modal-close-btn',
  TARIFF_MODAL_FORM:               'prices-manager-tariff-modal-form',
  TARIFF_MODAL_FORM_PRICE:         'prices-manager-tariff-modal-form-price',
  TARIFF_MODAL_FORM_DISC_TYPE:     'prices-manager-tariff-modal-form-discount-type',
  TARIFF_MODAL_FORM_DISC_VALUE:    'prices-manager-tariff-modal-form-discount-value',
  TARIFF_MODAL_FORM_START:         'prices-manager-tariff-modal-form-start',
  TARIFF_MODAL_FORM_END:           'prices-manager-tariff-modal-form-end',
  TARIFF_MODAL_ADD_BTN:            'prices-manager-tariff-modal-add-btn',
  TARIFF_MODAL_FORM_PREVIEW:       'prices-manager-tariff-modal-form-preview',
